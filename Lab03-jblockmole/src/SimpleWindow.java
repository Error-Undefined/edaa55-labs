...
public class SimpleWindow {
	 ...
	 * @return
	 */
	public SimpleWindow(int width, int height, String title, boolean fullscreen) {
	...
	/*-------- mouse- and keyboard-related operations --------*/
	...
	public void waitForEvent() {
		...
		if (lastEvent.getID() == KeyEvent.KEY_TYPED) {
			...
			System.err.println("Internal SimpleWindowError: " + " unknown event type, " + lastEvent.getID());
		}
...
class SWCanvas extends JPanel {
	...
	public SWCanvas(int width, int height) {
		...
		this.height = height;
		/*
		 * Creating the offscreen drawing image. Used to do it like this: img = new
		 * BufferedImage(width, height, BufferedImage.TYPE_BYTE_INDEXED); but then the
		 * colors are wrong (IndexColorModel instead of DirectColorModel.
		 */
